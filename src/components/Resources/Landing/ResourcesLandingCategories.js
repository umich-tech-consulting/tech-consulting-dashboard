    ...
    <>
      ...
      <div className='r-landing-categories-container'>
        <div className='r-landing-categories-cards'>
            ...
            <svg className="w-10 h-6 stroke-blue-10* dark:stroke-yellow-5*" xmlns="http://www.w3.org/2000/svg" width="40" height="24" fill="none" viewBox="0 0 40 24" role="img" aria-labelledby="group_rh">
            ...
            <svg className="w-10 h-6 stroke-blue-10* dark:stroke-yellow-5*" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 40 24" role="img" aria-labelledby="slasheye_rh">
