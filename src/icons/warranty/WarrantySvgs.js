...
export const DetailsDropdown = () => (
    <svg className="w-5 h-5 stroke-blue-9" xmlns="http://www.w3.org/2000/svg" fill="none">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" d="M16.25 6.875 10 13.125l-6.25-6.25"/>
    </svg>
);
export const Lightbulb = () => (
    <svg className="fill-blue-9 w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none">
...
export const ExternalLink = () => (
    <svg className="h-3 w-3 fill-blue-9" xmlns="http://www.w3.org/2000/svg" fill="none">
