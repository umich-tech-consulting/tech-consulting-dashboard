      ...
      <div className="r-page fade-in">
        <div className="r-groupbuilder-container">
          <div className="r-categorybuilder-nav">
            <Link to="/resources" className="hover:text-blue-10* dark:hover:text-yellow-5*">Resources</Link>
            <div>/</div>
            <Link to={`/resources/${category}`} className="hover:text-blue-10* dark:hover:text-yellow-5*">{categoryName.category}</Link>
          </div>
          ...
          <div className="r-groupbuilder-searchbox">
            ...
            />
            <svg className='absolute top-0 left-0 flex items-center justify-center h-full p-3 stroke-blue-10* dark:stroke-yellow-5*' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14" role="img" aria-labelledby="search_icon">
            ...
            {query && (
              <button
                ...
                onClick={() => setQuery("")}
              >
                <svg className='h-6 w-6 stroke-neutral-5 dark:stroke-neutral-3 hover:stroke-blue-10* dark:hover:stroke-yellow-5*' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20" role="img" aria-labelledby="default_x">
              ...
              <div className="mb-6 flex gap-2 items-center">
                ...
                <Link
                  to={`${groupData.group
                    ...
                    .replace(/[^a-zA-Z0-9-]/g, "-")}`}
                >
                  <svg className="h-6 w-6 stroke-blue-10* dark:stroke-yellow-5*" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" role="img" aria-labelledby="right_arrow">
