      ...
      <div className="r-page fade-in">
        <div className="r-groupbuilder-container">
          <div className="r-groupbuilder-nav">
            <Link to="/resources" className="hover:text-blue-10* dark:hover:text-yellow-5*">
              Resources
            </Link>
            <div>/</div>
            <Link to={`/resources/${category}`} className="hover:text-blue-10* dark:hover:text-yellow-5* min-w-fit">
              {categoryData.category}
            </Link>
            <div>/</div>
            <Link
              to={`/resources/${category}/${group}`}
              className="hover:text-blue-10* dark:hover:text-yellow-5* min-w-fit"
            >
              {categoryData.group}
            </Link>
          </div>
