export const WarrantyCheckDefault = () => (
    <svg className="w-16 h-16 stroke-blue-9" xmlns="http://www.w3.org/2000/svg" fill="none">
...
export const WarrantyShieldFullCoverage = () => (
    <svg className="stroke-green-1 w-16 h-16" xmlns="http://www.w3.org/2000/svg" fill="none">
...
export const WarrantyShieldPartialCoverage = () => (
    <svg className="stroke-yellow-5 dark:stroke-yellow-6 w-16 h-16" xmlns="http://www.w3.org/2000/svg" fill="none">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="4" d="M32 7a31.89 31.89 0 0 1-22.405 8.763A31.973 31.973 0 0 0 8 25.76C8 40.672 18.197 53.2 32 56.755c13.803-3.552 24-16.08 24-30.992 0-3.494-.56-6.856-1.595-10.003H54A31.88 31.88 0 0 1 32 7Z"/>
...
export const DetailsDropdown = () => (
    <svg className="w-5 h-5 stroke-blue-9 dark:stroke-yellow-6" xmlns="http://www.w3.org/2000/svg" fill="none">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" d="M16.25 6.875 10 13.125l-6.25-6.25"/>
    </svg>
);
export const Lightbulb = () => (
    <svg className="fill-blue-9 dark:fill-yellow-6 w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none">
...
export const ExternalLink = () => (
    <svg className="h-3 w-3 fill-blue-9 dark:fill-yellow-6" xmlns="http://www.w3.org/2000/svg" fill="none">
