...
const LeftNav = ({isToggleOn, handleToggleClick}) => {
  const location = useLocation();

  return (
    <div className={`box-border pt-5 pl-2 pr-2 h-screen border-r bg-white border-neutral-4 dark:bg-black dark:border-neutral-8 hidden sm:w-[72px] sm:block md:w-[72px] md:block lg:w-[72px] lg:block ${isToggleOn ? " xl:w-[72px]" : " xl:w-[230px]"} xl:block`}>
      ...
      <div className="mt-10 w-fit">
        ...
        >
          ...
          <div className={`title-medium text-neutral-9 dark:text-neutral-3 hidden xl:${isToggleOn ? "hidden" : "block"}`}>
            Asset Management
          </div>
        </Link>
        <Link
        ...
        >
          {location.pathname === "/announcements" ? (
            <svg className="fill-neutral-9 dark:fill-neutral-4" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
