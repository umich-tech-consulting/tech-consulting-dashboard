const LeftNav = () => {
    return (
      <div className="box-border p-5 h-screen border-r bg-white border-neutral-4 dark:bg-black dark:border-neutral-8 hidden sm:w-[96px] sm:block md:w-[96px] md:block lg:w-[96px] lg:block xl:w-[276px] xl:block">
        ...
        <div className="mt-24">
          <div className="p-4 rounded-xl flex content-center gap-x-4 bg-neutral-3 dark:bg-neutral-9">
          ...
          <div className="p-4 rounded-xl flex gap-x-4 bg-white dark:bg-black">
          ...
          <div className="p-4 rounded-xl flex gap-x-4 bg-white dark:bg-black">
            ...
            <div className="title-medium text-neutral-9 dark:text-neutral-4 hidden xl:block">Feedback</div>
          </div>
        </div>
      </div>
