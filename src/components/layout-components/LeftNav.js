      ...
      <div className="box-border p-5 h-screen border-r bg-white border-neutral-4 dark:bg-black dark:border-neutral-8 hidden sm:w-[96px] sm:block md:w-[96px] md:block lg:w-[96px] lg:block xl:w-[276px] xl:block">
        ...
        <div className="mt-24">
          ...
          <Link to="/announcements" className="p-4 rounded-xl flex gap-x-4 bg-white dark:bg-black">
            ...
            <div className="title-medium text-neutral-9 dark:text-neutral-4 hidden xl:block">Announcements</div>
          </Link>
          <Link to='/resources' className="p-4 rounded-xl flex gap-x-4 bg-white dark:bg-black">
            <svg xmlns="http://www.w3.org/2000/svg" className="fill-neutral-9 dark:fill-neutral-4" height="24" viewBox="0 96 960 960" width="24">
            ...
            <div className="title-medium text-neutral-9 dark:text-neutral-4 hidden xl:block">Resources</div>
          </Link>
        </div>
      </div>
